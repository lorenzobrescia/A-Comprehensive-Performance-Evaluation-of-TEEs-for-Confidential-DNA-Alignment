...
RESULT_FOLDER="/root/demos/minimap2/results"
...
do
    ...
    # Run minimap2
    occlum run /bin/minimap2 -t $c -x "sr" "/minimap_input_files/index/hg38.mmi" "/minimap_input_files/reads/SRR31527206/1.fastq" "/minimap_input_files/reads/SRR31527206/2.fastq" > "sample.sam"
...
do
    ...
    # Run Minimap2
    occlum run /bin/minimap2 -t $c -x "sr" "/minimap_input_files/index/hg38.mmi" "/minimap_input_files/reads/SRR30170738/1.fastq" "/minimap_input_files/reads/SRR30170738/2.fastq" > "sample.sam"
