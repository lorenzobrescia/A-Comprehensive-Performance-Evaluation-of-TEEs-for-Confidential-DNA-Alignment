...
do
	...
	# Run Bowtie2
	bowtie2-align-s -x /bowtie_input_files/index/hg38 -1 /bowtie_input_files/reads/SRR31527206/1.fastq -2 /bowtie_input_files/reads/SRR31527206/2.fastq -p $c > /dev/null 2>> $RESULT_FOLDER/alignment_stats.txt
...
do
	...
	# Run Bowtie2
	bowtie2-align-s -x /bowtie_input_files/index/hg38 -1 /bowtie_input_files/reads/SRR30170738/1.fastq.gz -2 /bowtie_input_files/reads/SRR30170738/2.fastq.gz -p $c > /dev/null 2>> $RESULT_FOLDER/alignment_stats.txt
